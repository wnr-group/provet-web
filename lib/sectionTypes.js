...
const SECTION_TYPES = {
  richText: {
    label: "Rich text",
    description: "A heading and body copy, shown in a card. Blank lines start a new paragraph.",
    fields: ["title", "body"],
  ...
  list: {
    label: "Bullet list",
    description: "One item per line, shown as checklist cards that tilt on hover.",
    fields: ["title", "body"],
    configSchema: z.object({}).strict(),
    defaults: {},
  },
  cards: {
    label: "Card grid",
    description: "One card per line, written as \"Heading: text\". Numbered 3D cards that tilt on hover.",
    fields: ["title", "body"],
  ...
  imageCards: {
    label: "Image cards",
    description: "Pictures with a heading and text: covers on a 3D shelf that scrolls sideways, or portrait cards for people.",
    fields: ["title", "body"],
    configSchema: z
      .object({
        ...
        imageStyle: z.enum(["cover", "card", "avatar"]).optional(),
